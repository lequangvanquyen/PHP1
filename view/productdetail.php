                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-lg-image-1 tf-element-carousel" data-slick-options='{
                        ...
                        <div class="lg-image">
                            ...
                            <a href="./view/layout/assets/images/product/large-product/<?= $img ?>" class="popup-img venobox" data-gall="myGallery"><i class="fa fa-expand"></i></a>
                        </div>
                        <div class="lg-image">
                            <img src="./view/layout/assets/images/product/<?= $img ?>" alt="">
                            <a href="./view/layout/assets/images/product/large-product/<?= $img ?>" class="popup-img venobox" data-gall="myGallery"><i class="fa fa-expand"></i></a>
                    ...
                    <div class="product-details-thumbs slider-thumbs-1 tf-element-carousel" data-slick-options='{
                        ...
                        <div class="sm-image"><img src="./view/layout/assets/images/product/<?= $img ?>" alt="product image thumb"></div>
                        <div class="sm-image"><img src="./view/layout/assets/images/product/<?= $img ?>" alt="product image thumb"></div>
        ...
        <div class="row tf-element-carousel" data-slick-options='{
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    <div class="product-img">
                        <a href="">
                            <img src="./view/layout/assets/images/product/product-5.jpg" alt="">
                        </a>
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Brush</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    <div class="product-img">
                        <a href="">
                            <img src="./view/layout/assets/images/product/product-6.jpg" alt="">
                        </a>
                        <span class="descount-sticker">-10%</span>
                        <span class="sticker">New</span>
                        <div class="product-action d-flex justify-content-between">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Brug</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    <div class="product-img">
                        <a href="">
                            <img src="./view/layout/assets/images/product/product-7.jpg" alt="">
                        </a>
                        <span class="descount-sticker">-10%</span>
                        <span class="sticker">New</span>
                        <div class="product-action d-flex justify-content-between">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Bruc</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    <div class="product-img">
                        <a href="">
                            <img src="./view/layout/assets/images/product/product-8.jpg" alt="">
                        </a>
                        <span class="descount-sticker">-10%</span>
                        <span class="sticker">New</span>
                        <div class="product-action d-flex justify-content-between">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Brusb</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Brux</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Bruz</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
                ...
                <div class="single-product mb-30">
                    ...
                    <div class="product-content">
                        <h3><a href="">White Shave Bruk</a></h3>
                        <div class="ratting">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
